...
class ClashMeta
{
    ...
    public function __construct($user, $servers, array $configPaths = [])
    {
        $this->user = $user;
        $this->servers = $servers;
        $this->defaultConfigPath = $configPaths['default'] ?? (base_path() . '/resources/rules/default.clash.yaml');
        $this->customConfigPath = $configPaths['custom'] ?? (base_path() . '/resources/rules/custom.clash.yaml');
    }
    ...
    public function handle()
    {
        ...
        $defaultConfig = $this->defaultConfigPath;
        $customConfig = $this->customConfigPath;
