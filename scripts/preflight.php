...
$result['checks']['subscribe_access_logs_table_exists'] = $schema->hasTable('v2_subscribe_access_logs');
$result['checks']['subscribe_ip_cache_table_exists'] = $schema->hasTable('v2_subscribe_ip_cache');
$result['checks']['subscribe_dispositions_table_exists'] = $schema->hasTable('v2_subscribe_dispositions');
$result['checks']['subscribe_disposition_logs_table_exists'] = $schema->hasTable('v2_subscribe_disposition_logs');
$result['checks']['subscribe_risk_snapshots_table_exists'] = $schema->hasTable('v2_subscribe_risk_snapshots');
$result['checks']['app_domain_groups_has_risk_levels'] = $schema->hasTable('v2_app_domain_groups') && $schema->hasColumn('v2_app_domain_groups', 'risk_levels');
$result['checks']['app_domain_groups_has_disposition_statuses'] = $schema->hasTable('v2_app_domain_groups') && $schema->hasColumn('v2_app_domain_groups', 'disposition_statuses');
$result['checks']['app_domain_groups_has_hide_matched_nodes'] = $schema->hasTable('v2_app_domain_groups') && $schema->hasColumn('v2_app_domain_groups', 'hide_matched_nodes');
...
$result['checks']['subscribe_monitor_asset_exists'] = is_file($target . '/public/assets/admin/subscribe-monitor-manager.js');
...
$result['checks']['ip2region_service_exists'] = is_file($target . '/app/Services/Ip2RegionService.php');
$result['checks']['ip2region_searcher_exists'] = is_file($target . '/app/Support/Ip2Region/Searcher.class.php');
$result['checks']['ip2region_xdb_exists'] = is_file($target . '/storage/ip2region/ip2region_v4.xdb');
$result['checks']['ip2region_xdb_size'] = $result['checks']['ip2region_xdb_exists'] ? filesize($target . '/storage/ip2region/ip2region_v4.xdb') : 0;
$result['checks']['ip_intelligence_importer_exists'] = is_file(__DIR__ . '/update_ip_intelligence.php');
