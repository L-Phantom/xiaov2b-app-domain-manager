...
$result['checks']['app_domain_assignments_table_exists'] = $schema->hasTable('v2_app_domain_assignments');
$result['checks']['app_domain_replace_batches_table_exists'] = $schema->hasTable('v2_app_domain_replace_batches');
...
$result['checks']['app_domain_groups_has_assignment_only'] = $schema->hasTable('v2_app_domain_groups') && $schema->hasColumn('v2_app_domain_groups', 'assignment_only');
